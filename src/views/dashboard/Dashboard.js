      ...
      
{
  /*
      ...
      <CContainer style={{marginTop:"30px"}}>
        <CRow className="justify-content-center" >
            <CCol xs={9} md={9} sm={9}>
              <CCard style={{ boxShadow:'0px 7px 29px 0px  rgba(100, 100, 111, 0.2) '}}>
                <CCardBody>
                  <CCardTitle>
                    <h4 style={{padding: "10px"}}>DELIVERY REPORT</h4>
                  </CCardTitle>
                  <DeliveryReportBar/>
                </CCardBody>
              </CCard>
            ...
            <CCol xs={3} md={3} sm={3}>
              <CCard style={{boxShadow:'0px 7px 29px 0px  rgba(100, 100, 111, 0.2)', backgroundColor:'#fff'}}>
                <CCardHeader>
                  <h6>DELIVERY REPORT - This Week</h6>
                </CCardHeader>
      ...
      <CContainer style={{marginTop:"30px", marginBottom: "30px"}}>
        <CRow className="justify-content-center" >
            <CCol xs={9} md={9} sm={9}>
              <CCard style={{ backgroundColor:'#fff', boxShadow:'0px 7px 29px 0px  rgba(100, 100, 111, 0.2) '}}>
                <CCardBody>
                  <CCardTitle>
                    <h4 style={{padding: "10px"}}>SENDER ID ACTIVITY</h4>
                  </CCardTitle>
                  <SenderIdBarChart/>
                </CCardBody>
              </CCard>
            ...
            <CCol xs={3} md={3} sm={3}>
              <CCard style={{boxShadow:'0px 7px 29px 0px  rgba(100, 100, 111, 0.2)', backgroundColor:'#fff'}}>
                <CCardHeader>
                  <h6>SENDER ID ACTIVITY - This Week</h6>
                </CCardHeader>
                <SenderIdPieChart/>
              </CCard>   
            </CCol>
